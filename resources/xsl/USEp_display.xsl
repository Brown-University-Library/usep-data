<?xml version="1.0" encoding="UTF-8"?>
 <xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:template match="/">
        ...
        <xsl:result-document href="test2.html">
            <div>
                ...
                <div class="titleBlurb">
                    <xsl:if test="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/*">
                        ...
                        <p><xsl:value-of select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:msContents/t:msItem/t:p"/>.<br/>
                            <xsl:value-of
                                select="normalize-space(/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:supportDesc/t:support/t:p)"
                            />. </p>
                    </xsl:if>
                </div>
                ...
                <div class="topDivs">
                        ...
                        <div class="metadata">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        <xsl:value-of
                                            select="id(substring-after(/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:supportDesc/@ana, '#'))/t:catDesc"
                                        />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <xsl:if test="$placeOfOrigin">
                                            ...
                                            <xsl:if test="not(normalize-space($dateOfOrigin)='')">
                                                <!-- whitespace count for empty -->
                                                <xsl:text>, </xsl:text>
                                            </xsl:if>
                                        </xsl:if>
                                ...
                                <xsl:for-each select="//t:provenance">
                                    <tr>
                                        ...
                                        <td class="value">
                                            <xsl:if test="$placeOfProvenance"><xsl:value-of select="$placeOfProvenance"/>, </xsl:if>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        <xsl:if test="$acquisitionDesc"><xsl:value-of select="$acquisitionDesc"/>, </xsl:if>
                                ...
                                <tr>
                                    ...
                                    <td class="value"><xsl:value-of
                                            select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:layoutDesc/t:layout/@columns"
                                        /> columns, <xsl:value-of
                                            select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:layoutDesc/t:layout/@writtenLines"
                                        /> lines</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="value">
                                        <xsl:value-of
                                            select="id(substring-after(/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:handDesc/t:handNote/@ana, '#'))/t:catDesc"/>
                                        <xsl:value-of select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:handDesc/t:handNote"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label">Condition</td>
                                    <td class="value"><xsl:value-of
                                            select="id(substring-after(/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:supportDesc/t:condition/@ana, '#'))/t:catDesc"
                                        />, <xsl:value-of
                                            select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:supportDesc/t:condition/t:p"
                                        /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="value">
                                        ...
                                        <xsl:value-of select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:decoDesc/t:decoNote"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <xsl:result-document href="test-image.html">
        ...
        <xsl:for-each select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:listBibl/t:bibl">
            ...
            <p>
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:value-of select="id($myID)/ancestor-or-self::t:bibl[@type='c' or @type='j']/t:title"/>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:otherwise>
                </xsl:choose>
                ...
                <xsl:if test="id($myID)/t:ref[@type='jstor']">
                    <br/> (<a href="{id($myID)/t:ref/@target}" class="biblink"><xsl:value-of select="id($myID)/t:ref[@type='jstor']"/></a> (external
                    link; access to JSTOR required) </xsl:if>
                <xsl:if test="t:ref">
                    <a href="{t:ref/@target}"><xsl:value-of select="t:ref"/></a> (external link) </xsl:if>
            </p>
        </xsl:for-each>
    </xsl:template>
</xsl:stylesheet>
