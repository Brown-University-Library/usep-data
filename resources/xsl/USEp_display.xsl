                ...
                <div class="titleBlurb">
                    <xsl:if test="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/*">
                        ...
                        <p><xsl:value-of select="/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:msContents/t:msItem/t:p"/>.<br/>
                            <xsl:if test="string(normalize-space(/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:supportDesc/t:support/t:p))">
                                <xsl:value-of select="concat(/t:TEI/t:teiHeader/t:fileDesc/t:sourceDesc/t:msDesc/t:physDesc/t:objectDesc/t:supportDesc/t:support/t:p, '.')"/>
                            </xsl:if>
                        </p>
                    </xsl:if>
                </div>
                                ...
                                <tr>
                                    <td class="label">Layout</td><td class="value">
                                       <xsl:choose>                              
                                           ...
                                           <xsl:when test="string-length($layout/@columns) !=0 and string-length($layout/@writtenLines) !=0 and $layout/@columns='1' and $layout/@writtenLines &gt;'1'"><xsl:value-of select="concat($layout/@column, ' column, ', $layout/@writtenLines, ' lines')"/></xsl:when>
