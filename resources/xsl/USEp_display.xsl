    ...
    <xsl:template match="/">
        <xsl:result-document href="#container"> 
            <div>
                ...
                <xsl:choose>
                    <xsl:when test="(/t:TEI/t:text/t:body/t:div[@type='edition']/t:ab and string-length(/t:TEI/t:text/t:body/t:div[@type='edition']/t:ab)!=0) or /t:TEI/t:text/t:body/t:div[@type='edition']/t:div[@type='textpart']">
                        <!-- transcribed folder -->
