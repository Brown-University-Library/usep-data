                            ...
                            <xsl:for-each select="t:graphic">
                                <xsl:choose>
                                    <xsl:when test="starts-with(@url, 'http')">
                                        <a href="{@url}" target="_blank" alt="image of inscription described on this page"><!-- class="highslide" 
