      ...
      <!-- This outputs the bibliography. No need to check, there is always bibliography. -->
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    ...
                    <p><a href="{concat('https://github.com/Brown-University-Library/usep-data/blob/master/xml_inscriptions/bib_only/',/t:TEI/t:teiHeader/t:fileDesc/t:publicationStmt/t:idno/@xml:id,'.xml')}">View XML source file (M)</a></p>
                </xsl:otherwise>
            </xsl:choose>
